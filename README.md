...
> Need a lighter setup? Compare the variants in [starter-harness](https://github.com/ivan-loh/starter-harness).
...
> When to update: When the project scope, setup steps, commands, ownership, or document links change.
> Owner: {{OWNER_NAME}}.
...
3. Fill in the core docs first, then fill in the interface, runtime, deployment, and release docs that apply.
...
- Read the runtime docs before changing operational behavior.
